...
const Navbar = () => {
  return (
    <div className='overflow-hidden bg-black flex justify-center'>
      <nav className='fixed w-full h-24 flex justify-between items-center p-4 bg-powder text-oxford bg-black text-teal-300 font-bold'>
        <div className='no-underline p-2 pl-4 lg:pl-60 text-base md:text-2xl  font-orbitron'>
          PHANTOMHEX
        </div>
